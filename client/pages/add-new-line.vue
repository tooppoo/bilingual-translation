...
export default {
  ...
  data: () => ({
    beSplit: Interaction.initialize(),
  }),
  methods: {
    ...
    onSplitBySentence: function () {
      this.beSplit = Interaction.splitBySentence('\\.')(this.origin)
    },
    onFinish: function () {
      this.$store.commit(messages.mutations.overwrite, this.beSplit)
      this.beSplit = Interaction.initialize()
    },
  },
  computed: {
    origin: function () {
